<?php return array (
  ...
  'admin.auth.defaultSourceDescription' => '<p>Angivelse af en anden standardgodkendelseskilde end OJS har følgende virkning:</p>
<ul>
	<li>Hvis en bruger forsøger at registrere en ny konto på dette websted med et brugernavn, der findes i godkendelseskilden (men ikke i OJS-databasen), vil registreringen kun lykkes, hvis den angivne adgangskode er gyldig for den pågældende brugerkonto.</li>
</ul>',
...
<ol type="a">
	...
	<li>Forfattere har ret til og opfordres til at publicere deres værker online (f.eks. i institutionslagre eller på deres websted) forud for og under manuskriptprocessen, da dette kan føre til produktive udvekslinger, samt tidligere og større citater fra publicerede værker (se <a target="_new" href="http://opcit.eprints.org/oacitation-biblio.html">The Effect of Open Access</a>).</li>
</ol>

<h4>Forslag til politik for tidsskrifter, der tilbyder forsinket Open Access</h4>
Forfattere, der publicerer deres værker via dette tidsskrift, accepterer følgende vilkår:
<ol type="a">
	<li>Forfattere bevarer deres copyright og giver tidsskriftet ret til første publicering, samtidigt med at værket [ANGIV TIDSPERIODE] efter publiceringen er omfattet af en <a target="_new" href="http://creativecommons.org/licenses/by/3.0/">Creative Commons Attribution-licens</a>, der giver andre ret til at dele værket med en anerkendelse af værkets forfatter og første publicering i nærværende tidsskrift.</li>
	 <li>Forfattere kan indgå flere separate kontraktlige aftaler om ikke-eksklusiv distribution af tidsskriftets publicerede version af værket (f.eks. sende det til et institutionslager eller udgive det i en bog), med en anerkendelse af værkets første publicering i nærværende tidsskrift.</li>
	 <li>Forfattere har ret til og opfordres til at publicere deres værker online (f.eks. i institutionslagre eller på deres websted) forud for og under manuskriptprocessen, da dette kan føre til produktive udvekslinger, samt tidligere og større citater fra publicerede værker (se <a target="_new" href="http://opcit.eprints.org/oacitation-biblio.html"> The Effect of Open Access</a>).</li>
</ol>',
...
<li>Brug <strong>*</strong> som wildcard i et ord for at søge efter tegnenes rækkefølge, f.eks. <em>soci* politik</em> returnerer dokumenter, der indeholder ordet "sociologisk" eller "social"</li>
  ...
  'about.aboutOJSJournal' => 'Dette tidsskrift anvender Open Journal Systems {$ojsVersion}, som er open source-software til administration og publicering af tidsskrifter, der er udviklet , understøttet og gratis distribueret af <a href="http://pkp.sfu.ca/">Public Knowledge Project</a> i henhold til GNU General Public License. Besøg PKP\'s websted for at <a href="http://pkp.sfu.ca/"> lære mere om softwaren </a>. <a href="{$contactUrl}"> Kontakt tidsskriftet </a> direkte med spørgsmål om tidsskriftet og indsendelser til tidsskriftet.',
  'about.aboutOJSSite' => 'Dette websted anvender Open Journal Systems {$ojsVersion}, som er open source-software til administration og publicering af tidsskrifter, der er udviklet , understøttet og gratis distribueret af <a href="http://pkp.sfu.ca/">Public Knowledge Project</a> i henhold til GNU General Public License.',
...
<p>Tak, fordi du downloadede Public Knowledge Projects <strong>Open Journal Systems</strong>. Før du fortsætter, skal du læse filen <a href="{$baseUrl}/docs/README.md">README</a>, der følger med denne software. Du kan finde flere oplysninger om Public Knowledge Project og dets softwareprojekter på <a href="http://pkp.sfu.ca/" target="_blank">PKP-webstedet</a>. Hvis du har fejlrapporter eller teknisk supportforespørgsler om Open Journal Systems, kan du se <a href="http://forum.pkp.sfu.ca" target="_blank">supportforum</a> eller besøge PKP\'s online <a href="https://github.com/pkp/pkp-lib#issues" target = "_ blank">bugrapporteringssystem</a>. Selvom supportforummet er den foretrukne kontaktmåde, kan du også sende PKP-teamet en e-mail på <a href="mailto:pkp.contact@gmail.com"> pkp.contact@gmail.com</a>.</p> 

<h4>Anbefalede systemkrav</h4>

<ul>
	<li><a href="http://www.php.net/" target="_blank">PHP</a> >= {$phpRequiredVersion}; du bruger i øjeblikket PHP {$phpVersion}{$wrongPhpText}</li>
...
<p>OJS er indtil videre kun blevet testet på MySQL og PostgreSQL, selvom andre databasestyringssystemer, der understøttes af <a href="http://adodb.sourceforge.net/" target="_blank">ADOdb</a>, muligvis fungerer (delvist eller fuldstændigt). Kompatibilitetsrapporter og/eller kodeprogramrettelser til alternative DBMS\'er kan sendes til OJS-teamet.</p>
',
  'installer.upgradeInstructions' => '<h4>OJS-version {$version}</h4>

<p>Tak, fordi du har downloadet Public Knowledge Projects <strong>Open Journal Systems</strong>. Læs filen <a href="{$baseUrl}/docs/README.md">README</a> og filen <a href="{$baseUrl}/docs/UPGRADE.md">UPGRADE</a>, der følger med denne software, inden du fortsætter. Du kan finde flere oplysninger om Public Knowledge Project og dets softwareprojekter på <a href="http://pkp.sfu.ca/" target="_blank">PKP web site</a>. Hvis du har fejlrapporter eller tekniske supportforespørgsler om Open Journal Systems, skal du se <a href="http://forum.pkp.sfu.ca" target="_blank">supportforum</a> eller besøge PKP\'s <a href="https://github.com/pkp/pkp-lib#issues" target="_blank">bug reporting system</a>. Selvom supportforummet er den foretrukne kontaktmåde, kan du også sende teamet en e-mail på <a href="mailto:pkp.contact@gmail.com">pkp.contact@gmail.com</a>.</p>
...
Serveren understøtter i øjeblikket mbstring: <strong>{$supportsMBString}</strong>',
  ...
  'installer.additionalLocalesInstructions' => 'Vælg eventuelt flere sprog, som dette system skal understøtte. Disse sprog kan anvendes af tidsskrifter, der er tilknyttet webstedet. Det er til enhver tid også muligt at installere flere sprog fra webstedsadministratorens grænseflade.',
...
<p>Installationsprogrammet kunne ikke automatisk overskrive konfigurationsfilen. Inden du forsøger at benytte systemet, skal du åbne filen <tt>config.inc.php</tt> i en passende teksteditor og erstatte dens indhold med indholdet i tekstfeltet nedenfor.</p>',
  'installer.installationComplete' => '<p>Installationen af OJS er fuldført.</p>
...
<p>Hvis du ønsker at være en del af PKP-fællesskabet, kan du:</p>
<ol>
 <li>Læse<a href="http://pkp.sfu.ca/blog" target="_new">PKP-bloggen</a>, og følge <a href ="http://pkp.sfu.ca/blog/feed" target ="_ new">RSS feed</a> med nyheder og opdateringer.</li>
<li>Besøg <a href="http://forum.pkp.sfu.ca" target="_new">supportforum</a>, hvis du har spørgsmål eller kommentarer.</li>
</ol>',
...
<p>Hvis du ikke allerede er registreret og ønsker at modtage nyheder og opdateringer, <strong>skal du registrere dig på <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> Hvis du har spørgsmål eller kommentarer, skal du besøge <a href="http://forum.pkp.sfu.ca" target="_new">supportforummet</a>.</p>',
  ...
  'article.accessLogoOpen.altText' => 'Fri adgang',
 ...
 <li>Fremhævede poster angiver, at handling er påkrævet af en redaktør. Det er mærket som følger:
  ...
  'site.upgradeAvailable.admin' => 'Der er en ny OJS-udgave tilgængelig! Du anvender i øjeblikket {$currentVersion}. Den nyeste OJS-udgave er {$latestVersion}. Besøg <a href="http://pkp.sfu.ca/ojs_download" target="_new">this page</a> og download den nyeste version og se opgraderingsinstruktionerne.',
  ...
  'user.authorization.noContext' => 'Intet tidsskrift i denne sammenhæng!',
