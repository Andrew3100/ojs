<?php return array (
  ...
  'article.coverPage.altText' => 'Obrázek obalu',
  ...
  'submission.event.author.authorRevision' => 'Autorova revize odeslána',
  'submission.event.general.authorRevision' => 'Autorův revidovaný soubor aktualizován',
  ...
  'submission.event.copyedit.copyeditorAssigned' => 'Redaktor přidělen k příspěvku',
  'submission.event.copyedit.copyeditorUnassigned' => 'Redaktor odebrán od příspěvku',
  'submission.event.copyedit.copyeditInitiated' => 'Přidělené redigování zahájeno',
  'submission.event.copyedit.copyeditRevision' => 'Soubor s revizemi redaktora aktualizován',
  ...
  'submission.event.proofread.proofreadRevision' => 'Soubor s korekturami aktualizován',
  ...
  'admin.auth.defaultSourceDescription' => '<p>Specifikování jiného výchozího zdroje ověření než OJS má následující efekt:</p>
<ul>
...
Volitelně můžete uživateli poskytnout zdůvodnění, proč byl jeho účet zablokován.',
 ...
 <li>"Termín splnění" je vyplněn v okamžiku, kdy recenzent přijme žádost o recenzi; ukazuje počet týdnů do termínu splnění nebo (-) počet týdnů po termínu.</li>
  ...
  'reviewer.article.decision.pendingRevisions' => 'Požadovat přepracování',
  ...
  'copyeditor.article.copyeditorFile' => 'Soubor od redaktora',
  'copyeditor.article.copyeditorFinalFile' => 'Soubor od redaktora',
...
<li>Jakmile byl příspěvek nahrán, klikněte na Uložit a pokračovat dole na této stránce.</li>
  ...
  'submission.copyedit.selectCopyeditor' => 'Přidělit redaktora',
...
(Po uložení je možné přidat další komentáře.)',
  ...
  'user.register.privacyStatement' => 'Prohlášení o soukromí',
...
<li>Použijte <strong>*</strong> v termínu jako divokou kartu pro nalezení jakékoliv sekvence znaků; např. <em>soci* etika</em> by vrátilo dokumenty obsahující "sociologický" nebo "sociální"</li>
  ...
  'about.privacyStatement' => 'Prohlášení o soukromí',
  ...
  'about.aboutOJSJournal' => 'Tento časopis používá Open Journal Systems {$ojsVersion}, což je open source software pro správu a publikování časopisů vyvinutý, podporovaný a volně šířený v rámci projektu Public Knowledge Project pod GNU General Public licencí. Navštivte webové stránky <a href="http://pkp.sfu.ca/">pokud se chcete dozvědět více o tomto software</a>.  <a href="{$contactUrl}">Kontaktujte přímo časopis</a> pokud máte jakékoliv otázky k časopisu a k možnostem do něj přispívat.',
  'about.aboutOJSSite' => 'Tato stránka používá Open Journal Systems {$ojsVersion}, což je open source software pro správu a publikování časopisů vyvinutý, podporovaný a volně šířený v rámci projektu <a href="http://pkp.sfu.ca/">Public Knowledge Project</a> pod GNU General Public licencí.',
  ...
  'installer.appInstallation' => 'OJS instalace',
...
<p>Děkujeme za stažení <strong>Open Journal Systému</strong> vytvořeného projektem Public Knowledge Project. Než budete pokračovat, přečtěte si, prosím, soubory <a href="{$baseUrl}/docs/README.md">README</a> a <a href="{$baseUrl}/docs/UPGRADE.md">UPGRADE</a> dodané s tímto softwarem. Pro více informací o Public Knowledge Project a jeho softwarových projektech navštivte prosím <a href="http://pkp.sfu.ca/" target="_blank">webové stránky PKP</a>. Pokud máte chybová hlášení nebo dotazy na technickou podporu OJS, navštivte <a href="http://forum.pkp.sfu.ca" target="_blank">fórum podpory</a> nebo navštivte PKP online <a href="http://pkp.sfu.ca/bugzilla/" target="_blank">bug reporting systém</a>. Přestože je support forum preferovaným způsobem kontaktování, můžete také týmu poslat email na <a href="mailto:pkp-support@sfu.ca">pkp-support@sfu.ca</a>.</p>
...
Váš server aktuálně podporuje mbstring: <strong>{$supportsMBString}</strong>',
  ...
  'installer.additionalLocalesInstructions' => 'Zvolte jakékoliv doplňkové jazyky, které mají být podorovány v tomto systému. Tyto jazyky budou dostupné pro použití v časopisech hostovaných na této stránce. Doplňkové jazyky mohou být také kdykoliv nainstalovány přes webové administrační rozhraní.',
...
<ol>
	<li>Číst <a href="http://pkp.sfu.ca/blog" target="_new">blog PKP</a> a sledovat <a href="http://pkp.sfu.ca/blog/feed" target="_new">RSS feed</a> pro informace o novinkách a aktualizacích.</li>
	<li>Navštívit <a href="http://forum.pkp.sfu.ca" target="_new">fórum podpory</a> s vašimi dotazy a komentáři.</li>
</ol>',
  'installer.upgradeComplete' => '<p>Upgrade OJS na verzi {$version} byl úspěšně dokončen.</p>
...
<p>Pokud jste se ještě nezaregistroval a přejete si dostávat informace o novinkách a aktualizacích, <strong>zaregistrujte se prosím na <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> Pokud máte otázky nebo komentáře, navštivte prosím <a href="http://forum.pkp.sfu.ca" target="_new">support forum</a>.</p>',
  'site.upgradeAvailable.admin' => 'Nová verze OJS je dostupná! V současné době používáte verzi OJS {$currentVersion}. Nejnovější verze OJS je {$latestVersion}. Navštivte, prosím, <a href="http://php.sfu.ca/ojs_download" target="_new">tuto stránku</a> a stáhněte si nejnovější verzi OJS a přečtěte si pokyny pro upgrade.',
  'site.upgradeAvailable.manager' => 'Je dostupná nová verze OJS! Vy používáte následující verzi OJS: {$currentVersion}. Nejnovější verze OJS je: {$latestVersion}. Kontaktujte, prosím, administrátora webu ({$siteAdminName}, <a href="mailto:{$siteAdminEmail}">{$siteAdminEmail}</a>) a upozorněte ho na novou verzi OJS. Více informací lze nalézt <a href="http://pkp.sfu.ca/ojs_download" target="_new">zde</a>.',
  ...
  'log.copyedit.initialEditComplete' => '{$copyeditorName} dokončil úvodní redigování příspěvku {$submissionId}.',
  'log.copyedit.finalEditComplete' => '{$copyeditorName} dokončil závěrečné redigování příspěvku {$submissionId}.',
  'log.copyedit.copyeditorAssigned' => '{$copyeditorName} byl přidělen pro redigování příspěvku {$submissionId}.',
  'log.copyedit.copyeditorFile' => 'Redaktorova verze souboru s příspěvkem byla nahrána.',
  ...
  'notification.type.reviewing' => 'Události recenzního procesu',
  'notification.type.site' => 'Události stránek',
  'notification.type.submissionComment' => 'Editor vložil poznámku k článku "{$title}."',
  'notification.type.submissions' => 'Události příspěvku',
  'notification.type.userComment' => 'Čtenář vložil poznámku k článku "{$title}."',
  'user.authorization.copyeditorAssignmentMissing' => 'Přístup není povolen! Nebyl/a vám přiřazena úloha lektora tohoto článku.',
  'user.authorization.sectionAssignment' => 'Snažíte se přistoupit k článku, který není součástí této sekce.',
  'user.authorization.invalidCopyditorSubmission' => 'Špatný příspěvek redaktora, nebo příspěvek redaktora není vyžadován!',
  ...
  'user.register.otherContextRoles' => 'Požadovat následující role.',
  ...
  'search.results.orderBy.popularityMonth' => 'Popularita (za měsíc)',
  ...
  'submission.layout.galley.remoteURL' => 'URL pro vzdáleně hostovaný obsah',
  ...
  'user.authorization.noContext' => 'Žádný časopis v kontextu!',
  ...
  'notification.type.approveSubmissionTitle' => 'Očekává se schválení.',
...
<p> 2. Adresář pro ukládání nahraných souborů musí být vytvořen a zapisovatelný (viz "Nastavení souborů" níže). </p>',
  ...
  'manager.setup.porticoDescription' => 'Portico je nezisková služba, která se zasazuje o uchování digitálních publikací, včetně e-časopisů, elektronických knih a digitalizovaných historických sbírek. Pokud podepsal váš časopis smlouvu s Portico, povolte tuto službu zde:',
  ...
  'notification.type.public' => 'Veřejné oznámení',
