<?php return array (
  'default.contextSettings.checklist.notPreviouslyPublished' => 'La submission non è stata precedentemente pubblicata, né proposta a un\'altra rivista (oppure si fornisce una spiegazione all\'editor nei commenti).',
  'default.contextSettings.checklist.fileFormat' => 'Il file di submission è in un formato OpenOffice, Microsoft Word, RTF, o WordPerfect.',
  'default.contextSettings.checklist.submissionAppearance' => 'Il testo ha spaziatura singola; usa un font 12 punti ; impiega il corsivo invece della sottolineatura (eccetto con gli indirizzi URL); e tutte le illustrazioni, figure, e tabelle sono posizionate  all\'interno del testo nei punti appropriati, piuttosto che alla fine.',
  'default.contextSettings.checklist.bibliographicRequirements' => 'Il testo aderisce alle richieste stilistiche e bibliografiche riassunte nelle <a href="{$indexUrl}/{$contextPath}/about/submissions#authorGuidelines">linee guida dell\'autore</a>, che si trova nella pagina di informazioni sulla rivista.',
  ...
  'default.contextSettings.checklist.addressesLinked' => 'Dove possibile, sono stati fornite gli URL delle referenze.',
