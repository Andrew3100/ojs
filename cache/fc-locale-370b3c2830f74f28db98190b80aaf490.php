...
<p>Se non hai ancora effettuato la registrazione e vuoi ricevere news e aggiornamenti, <strong>registrati a  <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong>Se hai commenti o domande, visita il <a href="http://forum.pkp.sfu.ca" target="_new">forum del supporto</a>.</p>',
  ...
  'manager.setup.clockssDescription' => 'OJS supporta ancche CLOCKSS (Controlled Lots of Copies Keep Stuff Safe) come sistema per avere una sicura e permanente archiviazione della rivista. Se la tua rivista ha siglato un contratto con il  CLOCKSS Archive, attivalo qui:',
  'manager.setup.porticoDescription' => 'Portico è un servizio no-profit per la preservazione delle pubblicazioni digitali. Se la tua rivista ha siglato un contratto con Portico, attivalo qui:',
